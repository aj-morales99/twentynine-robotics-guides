...
1. [Enter CAL MODE](./) and press **SW1 twice** for the enemy-sensor display.
2. Keep the area in front of every sensor clear and observe the baseline reading.
3. Hold a flat, matte target in front of one sensor.
4. Move the target slowly closer. That sensor's distance should decrease.
5. Move it away. The distance should increase toward the clear reading.
6. Repeat three times, then check the next sensor.
...
> **Supporting image coming later — MH-CAL-ENEMY-01**
> Top view identifying three-sensor and five-sensor positions without hiding wiring.
